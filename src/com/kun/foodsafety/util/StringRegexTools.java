package com.kun.foodsafety.util;
...
public class StringRegexTools {
	 ...
	 * http://www.suncer.com:8080/index.html?login=true matchResult.group(1) = http
	 * matchResult.group(2) = www.suncer.com matchResult.group(3) = :8080
